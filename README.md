...
Powerful agent models tore down the barrier to building software. So what *is* "development" to a **normal person** (*not the developer wired tight with logic and reason*)? Not a dry, academic definition. **"Just make it the way I pictured it."** — that's the development they actually want.
